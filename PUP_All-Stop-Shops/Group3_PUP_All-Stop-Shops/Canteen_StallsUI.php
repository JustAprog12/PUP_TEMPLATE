...
<body class="bg-[white] min-h-screen p-8 font-sans">
    ...
    <div class="bg-white max-w-[1500x] mx-auto rounded-md shadow-sm min-h-[800px]">
        ...
        <div class="px-10 mt-8 mb-4 flex flex-wrap items-end justify-between gap-4">
            <div>
                <h1 id="categoryTitle" class="font-playfair text-[3.25rem] leading-none text-gray-900 inline-block">Food</h1>
            ...
            <div class="flex items-center gap-3 flex-wrap">
                <select id="categorySelect" class="border border-gray-300 rounded-full px-4 py-2 text-sm text-gray-700 focus:outline-none focus:border-[#f83a45]">
                    <option value="Canteen_StallsUI.php" selected>Food</option>
                    <option value="SchoolSupplies_StallsUI.php">Services</option>
                    <option value="Vanity_StallsUI.php">Vanity/School Supplies</option>
                </select>
            ...
            <div id="stallsList" class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#f0f0f0] flex-shrink-0">
                        <img src="692330694_1902535573668483_1701272879610650123_n.jpg" alt="Fast Food" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg leading-snug">
                                <span class="block"> 4th J</span>
                                <span class="block text-sm text-gray-600 font-semibold">&amp; Fewa, Burger, Buko Juice</span>
                            </h3>
                            <span class="font-bold text-gray-900">Stall 20</span>
                        </div>
                        <p class="text-[#ffb800] font-bold text-sm mb-4">Review: 8/10</p>
                        
                        <!-- Weight/Input Badge -->
                        <div class="bg-white border border-gray-100 rounded-full px-4 py-1.5 w-max flex items-center gap-6 shadow-sm">
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#e2e2e4] flex-shrink-0">
                        ...
                        <img src="689176462_1021167314423992_2809289981350431651_n.jpg" alt="Ginger" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg">Waffle Time</h3>
                            <span class="font-bold text-gray-900">Stall 17</span>
                        </div>
                        <p class="text-[#ffb800] font-bold text-sm mb-4">Review: 8/10</p>
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#ececf0] flex-shrink-0">
                        <img src="683207248_35298413736469130_537543091657149547_n.jpg" alt="Stall" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg leading-snug">
                                <span class="block"> J.I.B. Food and Beverage</span>
                                <span class="block text-sm text-gray-600 font-semibold">&amp; Rice Meal, Drinks</span>
                            </h3>
                            <span class="font-bold text-gray-900">Stall 19</span>
                        </div>
                        <p class="text-[#ffb800] font-bold text-sm mb-4">Review: 8.5/10</p>
    ...
    <script>
        ...
        const staticData = [
            { service: 'Very Satisfied', owner: 'Andrea Maritinez', updated: '3 days ago' },
            { service: 'Extremely Satisfied', owner: 'Boyet Villanueva', updated: '1 week ago' },
            { service: 'Satisfied', owner: 'Diwata', updated: 'Yesterday' },
            { service: 'Highly Recommended', owner: 'Juan Dela Cruz', updated: '2 hours ago' }
        ];
        ...
        const parseStallNumber = (card) => {
            const label = card.querySelector('.stall-name')
                .closest('div')
                .querySelector('span')
                .textContent;
