...
<div class="container">
  <h1>About Us.</h1>
  <p class="subtitle">The people and mission behind PUP ★ All-Stop-Shops.</p>
  ...
  <p class="about-text">
    PUP ★ All-Stop-Shops is a campus-based platform built to connect students of the Polytechnic University of the Philippines with verified vendors and stalls within the university. We believe every student deserves easy access to affordable goods and transparent vendor information all in one place.
  </p>
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:1rem;margin-top:1rem;">
    ...
    <div style="border:1px solid #e0e0e0;border-radius:8px;padding:1.2rem;">
      <div style="display:inline-block;background:#8b1a1a;color:#fff;font-size:0.72rem;font-weight:600;padding:0.2rem 0.6rem;border-radius:4px;margin-bottom:0.7rem;">Stall 20 · 4th J · 8/10</div>
      ...
      <p style="font-size:0.88rem;color:#666;line-height:1.6;font-style:italic;">"Overall Satisfied"</p>
      <div style="margin-top:0.9rem;display:flex;justify-content:space-between;font-size:0.78rem;color:#999;"><strong style="color:#1a1a1a;">Vince</strong><span>May 2026</span></div>
    </div>

    <div style="border:1px solid #e0e0e0;border-radius:8px;padding:1.2rem;">
      <div style="display:inline-block;background:#8b1a1a;color:#fff;font-size:0.72rem;font-weight:600;padding:0.2rem 0.6rem;border-radius:4px;margin-bottom:0.7rem;">Stall 17 · Waffle Time · 8/10</div>
      <div style="display:flex;gap:2px;margin-bottom:0.6rem;">
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
      ...
      <p style="font-size:0.88rem;color:#666;line-height:1.6;font-style:italic;">"Satisfied"</p>
      <div style="margin-top:0.9rem;display:flex;justify-content:space-between;font-size:0.78rem;color:#999;"><strong style="color:#1a1a1a;">Naeomi</strong><span>May 2026</span></div>
    </div>

    <div style="border:1px solid #e0e0e0;border-radius:8px;padding:1.2rem;">
      <div style="display:inline-block;background:#8b1a1a;color:#fff;font-size:0.72rem;font-weight:600;padding:0.2rem 0.6rem;border-radius:4px;margin-bottom:0.7rem;">Stall 09 · Blessings Digital Photocopy · 8.5/10</div>
      <div style="display:flex;gap:2px;margin-bottom:0.6rem;">
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
        <div style="width:12px;height:12px;background:#2d6a2d;clip-path:polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%);"></div>
      ...
      <p style="font-size:0.88rem;color:#666;line-height:1.6;font-style:italic;">"Very very very Satisfied"</p>
      <div style="margin-top:0.9rem;display:flex;justify-content:space-between;font-size:0.78rem;color:#999;"><strong style="color:#1a1a1a;">Tricia</strong><span>May 2026</span></div>
    </div>
