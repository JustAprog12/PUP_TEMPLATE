...
<body class="bg-[white] min-h-screen p-8 font-sans">
    ...
    <div class="bg-white max-w-[1500x] mx-auto rounded-md shadow-sm min-h-[800px]">
        ...
        <div class="px-10 mt-8 mb-4 flex flex-wrap items-end justify-between gap-4">
            <div>
                <h1 id="categoryTitle" class="font-playfair text-[3.25rem] leading-none text-gray-900 inline-block">Services</h1>
            ...
            <div class="flex items-center gap-3 flex-wrap">
                <select id="categorySelect" class="border border-gray-300 rounded-full px-4 py-2 text-sm text-gray-700 focus:outline-none focus:border-[#f83a45]">
                    <option value="SchoolSupplies_StallsUI.php" selected>Services</option>
            ...
            <div id="stallsList" class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#f0f0f0] flex-shrink-0">
                        <img src="682709442_1942128596667420_3448043882987800749_n.jpg" alt="Print Services" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg">PrintBest</h3>
                            <span class="font-bold text-gray-900">Stall 8</span>
                        </div>
                        <p class="text-[#ffb800] font-bold text-sm mb-4">Review: 7/10</p>
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#e2e2e4] flex-shrink-0">
                        ...
                        <img src="685121248_2194739294700083_7307171400000473671_n.jpg" alt="Print Services" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg leading-snug">
                                <span class="block">Blessings Digital Photocopy</span>
                                <span class="block text-sm text-gray-600 font-semibold">&amp; Bookbind Services, Inc.</span>
                            </h3>
                            <span class="font-bold text-gray-900">Stall 9</span>
                        </div>
                ...
                <div class="stall-card bg-[#f9f9f6] border border-gray-200 rounded-2xl flex overflow-hidden shadow-sm">
                    <div class="w-44 sm:w-48 md:w-52 h-28 sm:h-32 md:h-36 bg-[#ececf0] flex-shrink-0">
                        <img src="686122632_991610683735669_8217395750968922291_n.jpg" alt="Stall" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6 flex-1 flex flex-col justify-center">
                        <div class="flex justify-between items-start mb-1">
                            <h3 class="stall-name font-bold text-gray-900 text-lg">N/A</h3>
                            <span class="font-bold text-gray-900">Stall 4</span>
                        </div>
                        <p class="text-[#ffb800] font-bold text-sm mb-4">Review: 7.5/10</p>
    ...
    <script>
        ...
        const staticData = [
            { service: 'Very Satisfied', owner: 'Claire Bautista', updated: '5 days ago' },
            { service: 'Highly Recommended', owner: 'Lily Santos', updated: '1 week ago' },
            { service: 'Satisfied', owner: 'Mark Santiago', updated: 'Yesterday' },
