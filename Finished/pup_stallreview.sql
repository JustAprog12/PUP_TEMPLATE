...
--
-- Host: localhost:3306
-- Generation Time: May 10, 2026 at 02:10 PM
...
INSERT INTO `cars` (`CarID`, `Brand`, `Model`, `Car_Year`, `Color`, `QUANTITY`, `Unit_Price`) VALUES
(1, 'Toyota', 'Corolla', 1995, 'black', 2, 65000),
(2, 'Isuzu', 'Crosswind', 2005, 'blue', 3, 150000),
(3, 'Chevrolet', 'Trailblazer', 2021, 'white', 2, 250000),
(4, 'Toyota', 'Innova', 2015, 'blue', 3, 374722),
(5, 'Jetour', 'Ice Cream', 2025, 'pink', 2, 80000),
(6, 'Ford', 'Wild trak', 2018, 'Orange', 2, 165843);
